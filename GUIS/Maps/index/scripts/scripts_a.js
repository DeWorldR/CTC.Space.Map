...
var destinationMarker = new mapboxgl.Marker({ color: '#ff0000' }) // เลือกสีส้มสำหรับเครื่องหมาย
  .setLngLat([99.82817908207899, 19.902706216640425])
  .addTo(map);
...
if ("geolocation" in navigator) {
  ...
  navigator.geolocation.getCurrentPosition(function(position) {
    ...
    destinationMarker.setLngLat([99.82817908207899, 19.902706216640425]);


    var directionsAPI = 'https://api.mapbox.com/directions/v5/mapbox/driving/' + lng + ',' + lat + ';' + '99.82817908207899' + ',' + '19.902706216640425' + '?steps=true&geometries=geojson&access_token=' + mapboxgl.accessToken;
    fetch(directionsAPI)
