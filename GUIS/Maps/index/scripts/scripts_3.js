...
var destinationMarker = new mapboxgl.Marker({ color: '#ff0000' }) // เลือกสีส้มสำหรับเครื่องหมาย
  .setLngLat([99.82695552266362, 19.9023915503565])
  .addTo(map);
...
if ("geolocation" in navigator) {
  ...
  navigator.geolocation.getCurrentPosition(function(position) {
    ...
    destinationMarker.setLngLat([99.82695552266362, 19.9023915503565]);


    var directionsAPI = 'https://api.mapbox.com/directions/v5/mapbox/driving/' + lng + ',' + lat + ';' + '99.82695552266362' + ',' + '19.9023915503565' + '?steps=true&geometries=geojson&access_token=' + mapboxgl.accessToken;
    fetch(directionsAPI)
